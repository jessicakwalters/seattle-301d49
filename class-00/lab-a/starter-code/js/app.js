...
function displayPics() {
  ...
  // the variable rando is declared within the scope of the function displayPics.  When we try to access that variable outside of the function scope, we can't!
  console.log(viewed);
